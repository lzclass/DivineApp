...
public class CalendarUtils {
     ...
     * 生肖
     */
    static String[] animalsName = new String[]{"鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊", "猴", "鸡", "狗", "猪"};
    /**
     * 时辰
     */
    static String[] SHICHEN = {"子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌", "亥", "子"};
    /**
     * 支持转换的最小农历年份
     */
    ...
    public static String getChinaDayString(int day) {
        ...
        String chineseDayNumber[] = {"一", "二", "三", "四", "五", "六", "七", "八", "九", "十"};
     ...
     * 阳历转农历
     */
    public static String getSolarToLunar(int year, int month, int monthDay) {
        String chineseNumber[] = {"正", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "腊"};
        int[] nongli = solarToLunar(year, month, monthDay);
        String lunarDate = getYearStr(nongli[0]) + "年 " + (nongli[3] == 1 ? "闰 " : "") + chineseNumber[nongli[1] - 1] + "月" + getChinaDayString(nongli[2]);
        return lunarDate;
    }
     ...
     * 获取星座
     */
    final public static String getAstro(int month, int day) {
